        ...
        <div className="grid w-full grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1.2fr] lg:gap-12">
          ...
          <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="min-w-0">
            ...
            <div className="mt-6 flex flex-wrap gap-2.5">
              <a href="#" aria-label="Instagram" className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] transition hover:-translate-y-1 hover:border-amber-400/30 hover:bg-amber-400/10 hover:text-amber-400">◎</a>
              <a href="#" aria-label="Website" className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] transition hover:-translate-y-1 hover:border-amber-400/30 hover:bg-amber-400/10 hover:text-amber-400"><Globe size={17} /></a>
              <a href="mailto:hello@luxewatches.com" aria-label="Email" className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/[0.03] transition hover:-translate-y-1 hover:border-amber-400/30 hover:bg-amber-400/10 hover:text-amber-400"><Mail size={17} /></a>
            </div>
          </motion.div>
              ...
              <div className="mt-5 flex flex-col gap-3.5">
                {column.links.map(([label, path]) => (
                  <Link key={label} to={path} className="group flex min-w-0 items-center gap-1 text-sm text-stone-500 transition hover:text-white">
                    ...
                    <ArrowUpRight size={12} className="shrink-0 opacity-0 transition group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:opacity-100" />
                  </Link>
                ))}
              </div>
            </motion.div>
