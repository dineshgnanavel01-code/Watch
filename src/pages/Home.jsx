  ...
  return (
    <div className="w-full overflow-hidden bg-stone-950">
      ...
      <section className="w-full bg-stone-950">
        <div className="mx-auto w-full max-w-full px-5 py-20 sm:px-8 lg:px-14 lg:py-28"><div className="mb-12 text-center"><p className="section-label">The House Edit</p><h2 className="heading-lg mt-5 text-white">Explore by Collection</h2></div>
